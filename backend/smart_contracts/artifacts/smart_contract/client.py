...
class SmartContractClient:
    """A class for interacting with the smart_contract app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        SmartContractClient can be created with an app_id to interact with an existing application, alternatively
